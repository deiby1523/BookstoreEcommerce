...
<main>
    <div class="row mt-4">
        <div class="col-md-3">
            <a class="btn bg-transparent mb-0 mt-lg-auto" href="{{route('banner.index')}}">
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title">Añadir banner</h2>

            <div class="card">

                <div class="card d-flex justify-content-center p-4 shadow-lg">
                    <form role="form" id="contact-form" method="POST" autocomplete="off"
                          action="{{ route('banner.save') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        @if(count($errors->get('banner_name')) >= 1)
                                            <input name="banner_name" id="banner_name" class="form-control"
                                                   placeholder="Nombre del anuncio" aria-label="Full Name"
                                                   type="text"
                                                   style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;"
                                                   value="{{app('request')->old('banner_name', null)}}">
                                        @else
                                            <input name="banner_name" id="banner_name" class="form-control"
                                                   placeholder="Nombre del anuncio" aria-label="Full Name"
                                                   type="text" value="{{app('request')->old('banner_name', null)}}">
                                        @endif
                                    </div>
