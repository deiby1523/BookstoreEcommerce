    ...
    <div class="section my-4 my-lg-5">
        <div class="container">
            <div class="row flex-row">
                <div class="col-lg-5">
                    <img class="w-80 shadow-lg border-radius-lg img-fluid ms-2" src="{{asset($product->product_image_url)}}" alt="ladydady" loading="lazy">
                </div>
                <div class="col-lg-7">
                    <div>
                        ...
                        <p class="text-lg">$ {{number_format($product->product_price - $product->product_price * ($product->product_discount / 100))}}</p>
