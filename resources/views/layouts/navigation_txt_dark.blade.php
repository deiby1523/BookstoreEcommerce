            ...
            <ul class="navbar-nav navbar-nav-hover">
                ...
                <li class="nav-item mx-4" style="width:500px">
                    <div class="input-group input-group-dynamic">
                        ...
                        <input id="searchNav" name="searchNav" type="text" class="form-control" placeholder="Buscar Libro">



                        <!-- TODO: Seguir trabajando en el buscador de libros en la pagina de inicio -->
