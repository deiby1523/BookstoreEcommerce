...
<main>
    <div class="row mt-4">
        <div class="col-md-3">
            <a class="btn bg-transparent mb-0 mt-lg-auto" href="{{route('category.index')}}">
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @if(count($errors->get('category_description')) >= 1)
                                    <textarea name="category_description" class="form-control" id="category_description"
                                              rows="6"
                                              placeholder="Una descripcion breve de la categoria" style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;">{{$category->category_description}}</textarea>
                                @else
                                    <textarea name="category_description" class="form-control" id="category_description"
                                              rows="6"
