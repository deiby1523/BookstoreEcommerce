...
@php
    ...
    if ($section->section_use_custom_code == 1) {
        $currentPane = 2;
    }
@endphp
...
<main>
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title mb-0">Editar sección</h2>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade {{$currentPane == 2 ? 'show active':''}}"
                    ...
                    <section id="custom-html" style="scroll-margin-top: 20px;">
                        ...
                        <div class="card">
                            <form role="form" method="POST" autocomplete="off"
                                  action="{{route('section.updateCustom',$section->id)}}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-header">
                                    ...
                                    <label class="py-3">Activo</label>
                                    <div class="form-check form-switch mb-6">
                                        @if(count($errors->get('custom_active')) >= 1)
                                            @if($section->active)
                                                <input class="form-check-input checked:true" type="checkbox" id="custom_active" name="custom_active"
                                                       style="scale: 1.3; margin-left: 0.03px" checked>
                                            @else
                                                <input class="form-check-input" type="checkbox" id="custom_active" name="custom_active"
                                                       style="scale: 1.3; margin-left: 0.03px">
                                            @endif
                                        @else
                                            @if($section->active)
