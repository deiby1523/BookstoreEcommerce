        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="position-relative">
                    ...
                    <div class="position-absolute top-0 end-0 text-white px-3 py-2 rounded shadow m-3 text-bold" style="background-color: rgba(255, 0, 0, 0.5);">
            ...
            <div class="col-lg-7">
                ...
                <div class="mb-4">
                    @if($book->book_discount > 0)
                        <span class="text-decoration-line-through text-muted me-2">${{ number_format($book->book_price) }}</span>
                        <span class="text-dark fw-bold fs-3">${{ number_format($book->book_price * (1 - $book->book_discount/100)) }}</span>
                    @else
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person me-2 text-muted" viewBox="0 0 16 16">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-building me-2 text-muted" viewBox="0 0 16 16">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-book me-2 text-muted" viewBox="0 0 16 16">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-earmark-text me-2 text-muted" viewBox="0 0 16 16">
                            ...
                            <div>
                                ...
                                <p class="mb-0">
                                    @switch($book->book_format)
                                        @case('paperback') Tapa blanda @break
                                        @case('hardcover') Tapa dura @break
