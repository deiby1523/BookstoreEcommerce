...
<body class="loading">
    ...
    <div id='load' class="loading">
        ...
        <div class="card card-body shadow-xl mx-3 mx-md-4" style="margin-top: 15rem">
            ...
            <section class="about-header py-5 text-center mb-5" style="background-image: url({{asset('img/about_us.webp')}})">
                {{-- <div class="container">
                ...
                <div class="container">
                    <div class="row text-center">
                        <div class="col-md-4 mb-4">
                            ...
                            <p class="text-muted">
                                Brindar un servicio de excelencia en la comercialización de literatura,
                                papelería y artículos religiosos, promoviendo la evangelización,
                                la cultura y la educación para el desarrollo integral de nuestra comunidad.
                            </p>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="mission-icon mb-3">
                            ...
                            <p class="text-muted">
                                Consolidarnos como un referente cultural y espiritual a nivel regional y nacional,
                                ofreciendo un servicio humano y cercano que inspire fe, conocimiento y esperanza,
                                transformando vidas a través de la cultura y la espiritualidad.
                            </p>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="mission-icon mb-3">
                            ...
                            <p class="text-muted">
                                Fe, cultura, servicio, calidad, tradición, innovación con propósito y esperanza,
                                principios que guían cada acción para impactar positivamente a las personas y
                                comunidades.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <div class="location-card">
                                ...
                                <div class="map-container1">
                                    ...
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d247.44158323004612!2d-73.12684408585116!3d7.118427829093742!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e683fd6f0b50f77%3A0xed821e79ff954397!2sLa%20Libreria%20Vida%20S.A.S!5e0!3m2!1ses-419!2sco!4v1757889159247!5m2!1ses-419!2sco"
                                        width="100%" height="100%" style="border:0;" allowfullscreen=""
                                        loading="lazy">
                                    </iframe>
                                </div>
                                <div
                                    class="map-container2 bg-gray-200 d-flex align-items-center justify-content-center">
                                    <div class="text-center p-4 mt-3">
                                        {{-- <i class="material-icons-round text-primary" style="font-size: 4rem;">place</i> --}}
                                        <h4>Calle 35#14-52</h4>
                                    ...
                                    <i class="material-icons-round mr-2">directions</i> Cómo llegar
                                        ...
                                        <a class="btn btn-lg bg-gradient-warning me-1 mt-4 mt-md-0 mb-4" target="_blank"
                                            href="https://maps.app.goo.gl/Q6SEb4ry16Sdx2fKA">¿Cómo llegar?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="hours-table">
                                        <tr>
                                            ...
                                            <td class="text-right">8:30 AM - 6:00 PM</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Sábados</strong></td>
                                            <td class="text-right">8:30 AM - 5:00 PM</td>
                                        </tr>
                                        {{-- <tr>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <p style="font-size: 20px"><i class="material-icons-round mr-2">phone</i> +57
                                            316 010 7642</p>
                                        <p style="font-size: 20px"><i class="material-icons-round mr-2">email</i>
                                            Libreriavida.representaciones@gmail.com</p>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <p>Parqueadero Colon, Cl. 34 # 14-79 - 3 min caminando</p>
                                        <p>Moreno's parking, Cl. 37 #14 49 sotano - 5 min caminando</p>
                                    </div>
                                </div>
                            </div>
                        </div>
