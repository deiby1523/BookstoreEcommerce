...
<head>
    ...
    <style>
        ...
        /* Tablet (pantallas de 768px en adelante) */
        ...
        /* PC/Laptop (pantallas de 992px en adelante) */
                ...
                <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                    <ol class="carousel-indicators">
                        ...
                        @foreach ($banners as $banner)
                            @if ($banner->active)
                                <li data-target="#carouselExample" data-bs-slide-to="{{ $i++ }}"
                                    class="active d"></li>
                            @endif
                        @endforeach
                    </ol>
        ...
        <div class="card card-body shadow-xl mx-3 mx-md-4" style="margin-top: 2rem">
            ...
            <div class="my-5">
                <img class="img-custom position-absolute end-0 border-radius-top-start-lg"
                    src="{{ asset('img/bg-16.jpg') }}" alt="lakeHouse" loading="lazy" style="max-width: 734px;">
                <div class="container">
                    <div class="row mt-8">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-lg-2 order-2">
                            ...
                            <p class="lead mb-4">Descubre nuestra colección de objetos sagrados para fortalecer tu fe
                            </p>

                            <p class="mb-5">En nuestra tienda, no solo ofrecemos libros espirituales, sino también
                                una cuidadosamente seleccionada gama de artículos religiosos. Cada pieza en nuestro
                                catálogo ha sido elegida por su significado espiritual y calidad artesanal.</p>
                        ...
                        <div class="col-lg-6 order-lg-1 order-1 mb-4 mb-lg-0">
                            <div class="position-relative">
                                <img src="{{ asset('img/picture4.jpg') }}"
                                    ...
                                    alt="Artículos religiosos" style="">
                                    ...
                                    <div class="book-content">
                                        ...
                                        <h5 class="book-title">
                                            <a href="{{ route('book.view', $book->id) }}"
                                                class="text-decoration-none data-bs-toggle='tooltip' data-bs-placement='top' title='${book.book_title}'">{{ $book->book_title }}</a>
                                        </h5>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <p class="mb-0 text-center" style="font-size: 20px">
                                    {{ $featured->featured_type_description }}</p>
                            </div>
                            <div id="latestBooks" class="book-horizontal-slider">
                                <div class="row flex-nowrap rowBooks" style="max-width: 210px; position: relative;">
                                    @foreach ($featured->books as $book)
                                        <div class="book-card">
                                            ...
                                            <div class="book-content">
                                                <span
                                                    class="book-category">{{ $book->subcategory->subcategory_name }}</span>
                                                <h5 class="book-title">
                                                    <a href="{{ route('book.view', $book->id) }}"
                                                        class="text-decoration-none data-bs-toggle='tooltip' data-bs-placement='top' title='${book.book_title}'">{{ $book->book_title }}</a>
                                                </h5>
                                ...
                                <div class="container">
                                    <div class="row mb-5">
                                        <div class="col-lg-8 text-center mx-auto">
                                            <p class="mb-1 text-{{ $color }} text-uppercase font-weight-bold">
                                                {{ $section->section_secondary_title }}</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="px-4">
                                                <p class="text-gradient text-{{ $color }}">
                                                    {{ $section->section_secondary_sub_title }}</p>
                                                <h3 class="mb-4">{{ $section->section_sub_title }}</h3>
                                                <p>{{ $section->section_text_1 }}
                                                    <br><br>
                                                    <a class="link-{{ $color }}"
                                                        href="{{ $section->section_btn_link }}">Más
                                                        info</a>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-10 mx-auto bg-gradient-dark border-radius-lg"
                                            ...
                                            <div class="row py-5">
                                                ...
                                                <div
                                                    ...
                                                    <i
                                                        class="material-symbols-rounded text-white text-5xl">{{ $section->section_main_title }}</i>
                                                ...
                                                <div class="col-xl-2 col-12 px-xl-0 px-5 my-xl-auto">
                                                    <h3 class="text-white mt-xl-0 mt-5">
                                                        {{ $section->section_sub_title }}</h3>
                                                    <p class="text-sm text-white opacity-8">
                                                        {{ $section->section_text_2 }}</p>
                                                    <a href="{{ $section->section_btn_link }}"
                                    ...
                                    <div class="cursor-pointer">
                                        <div class="card card-background">
                                            <div class="full-background"
                                                style="background-image: url('{{ asset($section->section_image_1_url) }}')">
                                            </div>
                                            <div class="card-body pt-7 text-center">
                                                ...
                                                <a href="{{ $section->section_btn_link }}"
                                                    class="btn btn-white btn-sm mt-3">Más
                                                    info
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div
                                                ...
                                                <h6 class="category text-{{ $color }} mt-3">
                                                    {{ $section->section_secondary_title }}</h6>
                                                <h3 class="card-title">
                                                    <a href="javascript:;"
                                                ...
                                                <p class="card-description">
                                                    {{ $section->section_text_1 }}
                                                    <a href="{{ $section->section_btn_link }}"
                                                        class="text-{{ $color }} icon-move-right text-sm">Más
                                                        info
                                                        <i class="fas fa-arrow-right text-xs ms-1"></i>
                                                    </a>
                                                </p>
