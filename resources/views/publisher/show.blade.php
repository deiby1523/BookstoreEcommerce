...
<main>
    <div class="row mt-4">
        <div class="col-md-3">
            <a class="btn bg-transparent mb-0 mt-lg-auto" href="{{route('publisher.index')}}"><svg style="margin-right: 1rem" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
...
{{--                        </div>--}}
                        ...
                        <div class="row">
                            <div class="col-md-12 text-start">
                                <a href="{{route('publisher.index')}}" class="btn bg-gradient-danger mt-3 mb-0">Volver
                                </a>
                            </div>
